...
<Tip>
  This quickstart uses the React web SDK. If you're building for React Native, use `@chainrails/react-native` with the same backend
  session endpoint pattern described below.
</Tip>

<Steps>
<Step title="Installation">
Begin by installing the Chainrails SDK for your platform.
