...
In very rare cases where an intent’s final status cannot be determined automatically (for example, due to an indexer outage), you can trigger a refund manually using the `GET /api/v1/intents/{intent_address}/refund`. 
