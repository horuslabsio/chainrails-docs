...
### Step 4 — Fund the Payment Intent
...
1. Intent addresses are like **one-off account numbers**, you cannot reuse them, so always generate a new intent for every transaction.
