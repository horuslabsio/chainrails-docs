...
5. Live API keys cannot be used with test networks. In test environments you can use supported mainnets and testnets, but once you
  switch to a live API key you must use mainnet networks only.
6. Testnets also do not have indexing support. You must manually call
