...
**NB:** You can however trigger the intent processing flow manually, if the indexer goes down for any reason or missed a transaction, using the `GET /api/v1/intents/{intent_address}/trigger-processing` endpoint.
