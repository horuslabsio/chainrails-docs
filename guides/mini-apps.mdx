---
title: "Mini-Apps"
description: "Integrate Chainrails into Farcaster/Base MiniApps"
icon: "mobile-screen"
---
...
<Tip>To support more chains, add them to the `wagmiConfig`. Check our supported chains for the full list.</Tip>
...
<Card title="Github Example" icon="stars" href="https://github.com/horuslabsio/chainrails-demo/tree/main/mini-apps">
