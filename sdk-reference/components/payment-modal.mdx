...
React component and hooks for integrating Chainrails payments into your app. Choose between two integration patterns depending on your use case.
...
- `styles` (object, optional): Custom styling (e.g., `{ accentColor: "#FF6B6B" }`)
...
return (
  <PaymentModal
    {...cr}
    styles={{
      accentColor: "#FF6B6B", // Primary brand color
