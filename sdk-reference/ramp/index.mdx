...
- **Session Support**: Full integration with Chainrails Payment Modal for a seamless experience
...
<CardGroup>
  <Card title="Get Quotes" icon="tag" href="/sdk-reference/ramp/get-quotes">
    Compare fiat-to-crypto rates across all providers
  </Card>
  <Card title="Create Order" icon="plus" href="/sdk-reference/ramp/create-order">
...
2. **PENDING_PAYMENT**: User redirected to provider widget
