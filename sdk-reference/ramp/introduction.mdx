...
- **Global Coverage**: Support for 35+ countries and 20+ fiat currencies
...
<CardGroup>
  <Card title="Get Countries" href="/sdk-reference/ramp/get-countries">
    List all supported countries with currency details
  </Card>
  <Card title="Get Currencies" href="/sdk-reference/ramp/get-currencies">
  ...
  <Card title="List Orders" href="/sdk-reference/ramp/list-orders">
    List all orders
  </Card>
  <Card title="Get Order" href="/sdk-reference/ramp/get-order">
    Retrieve a specific order details by it's id
  </Card>
  <Card title="Confirm Order" href="/sdk-reference/ramp/confirm-order">
    Confirm order after user completes deposit
  </Card>
  <Card title="Cancel Order" href="/sdk-reference/ramp/cancel-order">
